...
public interface StudentService {
	...
	public List<Studentcost> studentcostForList(); //2.不同年级学生的平均消费水平(jyje)
	...
	public List<Studentst> studentoneForList();//4.南海一饭堂
	public List<Studentst> studenttwoForList();//5.南海二饭堂
	
	public List<Studentavgcost> studentavgcostForList(); //6.低于平均消费水平的学生之中不同年级之间的占比
